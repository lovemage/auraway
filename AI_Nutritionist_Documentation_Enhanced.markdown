...
**核心推薦理念**：
- **積極保健**：秉持「預防勝於治療」的理念，為每位用戶提供適合的營養補充建議
- **個人化**：基於年齡、性別、生活習慣進行個人化推薦
- **全面性**：確保每位用戶都能獲得至少3-5個產品推薦
- **科學性**：所有推薦都有營養學依據支持
- **智能補強**：當推薦數量不足時，系統會自動添加基礎保健產品確保用戶獲得完整建議

**推薦保證機制**：
1. **基於健康目標的顯性推薦**：直接對應用戶選擇的健康目標
2. **基於生活習慣的隱性推薦**：分析用戶的睡眠、飲食、運動等習慣
3. **基於人口統計學的基礎推薦**：年齡、性別特定的營養需求
4. **智能補強推薦**：確保每位用戶至少獲得3-5個產品建議
