...
function NattokinaseProductPage() {
  const images = [
    ...
    <div className="ProductPage">
      <div className="product-container">
        ...
        <div className="product-details">
          ...
          <p className="product-description">
            來自日本的頂級蚓激酶配方，採用納豆發酵技術萃取，
            有助於促進血液循環，維護心血管健康，為您的健康提供全方位的守護。
          </p>
      ...
      <div className="additional-info">
        ...
        <div style={{ 
          ...
          <img 
            src="/images/日本-蚓激酶/19f4aec57b7df48e36b964c95fc990a9.jpg" 
            alt="日本蚓激酶產品成分與功效說明" 
            style={{ 
              width: '100%', 
              maxWidth: '800px', 
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.9em' }}>維護心血管健康</p>
          </div>
          <div style={{ 
            textAlign: 'center', 
            padding: '20px',
            ...
            <h3 style={{ color: 'var(--secondary-color)', marginBottom: '10px' }}>血液循環</h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.9em' }}>促進血液流動</p>
          </div>
          <div style={{ 
            textAlign: 'center', 
            padding: '20px',
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.9em' }}>高活性蚓激酶</p>
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <p style={{ color: 'var(--text-primary)', fontSize: '0.9em' }}>維護心血管健康</p>
          </div>
          <div style={{ 
            ...
            <p style={{ color: 'var(--text-primary)', fontSize: '0.9em' }}>久坐缺乏運動</p>
          </div>
          <div style={{ 
            background: 'var(--light-teal)', 
            padding: '20px', 
            ...
            <h4 style={{ color: 'var(--primary-color)', marginBottom: '10px' }}>健康維護者</h4>
            <p style={{ color: 'var(--text-primary)', fontSize: '0.9em' }}>預防保健意識高</p>
          </div>
        </div>
...
export default NattokinaseProductPage; 